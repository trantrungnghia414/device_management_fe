...
const List = () => {
    ...
    },
    {
      ...
      cellRenderer: (params) => (
        <div className="flex gap-2">
          <Link
            to={`${config.routes.buildingsEdit.replace(":id", params.data.id)}`}
          >
  ...
  return (
    <div>
      <h1 className="text-center text-2xl font-semibold">Quản lý tòa nhà</h1>
      <Link
        to={config.routes.buildingsAdd}
