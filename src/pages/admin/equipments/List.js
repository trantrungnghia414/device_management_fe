...
const List = () => {
    ...
    },
    {
      ...
      cellRenderer: (params) => (
        <div className="flex gap-2">
          <Link
            to={`${config.routes.equipmentEdit.replace(":id", params.data.id)}`}
          >
  ...
  return (
    <div>
      <h1 className="text-center text-2xl font-semibold">Quản lý thiết bị</h1>
      <Link
        to={config.routes.equipmentAdd}
